...
<!--estilos para los cards de comentarios-->
  <style>
...
function enviarCorreo() {
    // Perform AJAX request to trigger email sending
    // Example using jQuery AJAX:
    $.ajax({
        type: "POST",
        url: "pruebas2.php", // Replace with the actual URL of your PHP script
        data: $("#manage_ticket").serialize(), // Serialize form data
        success: function(response) {
            // Handle success, e.g., show a success message
           // alert("Ticket creado y correo enviado!");
        },
        error: function() {

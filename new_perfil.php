...
<?php if (@$_GET["i"] == 'ok') { // Quiere decir que el fundamento se envio correctamente?>
  <center>
    <h3> La informacion se genero correctamente , gracias!
      <br><br>
      <div class="Reportes">
        <a href="new_perfil.php" class="btn btn-success" style="
       margin-left: 8px;
           padding-left: 272px;
           padding-right: 255px;
  ...
  ?>
  <form id="manage_ticket" class="needs-validation" action="./proceso_perfiles/proceso_guardar.php"
    ...
    <div class="form-row">
      ...
      <div class="col-md-3 mb-2">
        ...
        <input type="text" readonly="readonly" class="form-control" id="validationCustom02" placeholder=""
          name="fecha_crea" value="<?php echo $fechaActual ?>">
      </div>
    </div> <!--Cierre-->
    <br><br><br>
